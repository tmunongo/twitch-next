...
import { RiMovieLine, RiTrophyFill } from 'react-icons/ri'
...
const SideMenu = () => {
  return (
    <div className='fixed w-14 sm:w-16 xl:w-[15rem] h-screen p-2 bg-[#0e0e10]'>
        ...
        <div>
            <p className='hidden xl:flex uppercase font-bold text-sm py-6 text-center'>Top Channels</p>
            <p>
                <RiTrophyFill size={20} className='xl:hidden justify-center w-full' />
            </p>
        </div>
